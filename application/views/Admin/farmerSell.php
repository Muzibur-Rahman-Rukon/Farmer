   ...
   ?>
    ...
    <?php } ?>
      ...
      <?php 
       ...
       ?>
       <td><button class="btn btn-danger"><a style="color:#ffff" href="<?php echo base_url('admin/changeFSStatus/'.$p->id) ?>">Payment Not Ok</a></button></td>

     <?php } else{ ?>
      <td style="color: green">Payment OK</td>
     ...
     <?php } ?>
      ...
      <td><button class="btn btn-success"><a style="color:#ffff" href="<?php echo base_url('admin/viewFarmerAddress1/'.$p->user_id) ?>">View Farmer Address</a></button></td>
