<div class="content-wrapper">
  <div class="row padtop">
    ...
    <div class="col-md-6" style="margin-left: 200px;margin-top: 50px">
      <h2>Add Sub District</h2>
      <br>
      <?php echo form_open_multipart('admin/adSubDistrict','','') ?>
  ...
  <br>
      <div class="form-group">
        <label for="sel1">Sub District</label><br>
        <?php echo form_input('subDistrict_name','','class="form-congrol"'); ?>
      </div>
      
      <div class="form-group">
        <?php echo form_submit('Add Sub Division','Add Sub District','class="btn btn-primary"'); ?>
      </div>
      <div>
