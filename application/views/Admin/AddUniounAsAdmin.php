<div class="content-wrapper">
	<div class="row padtop">
		...
		<div class="col-md-6 col-md-offset-2" style="margin-left: 150px;margin-top: 30px">
			...
			<?php echo form_open_multipart('admin/uniounadmin','','') ?>
...
<input name="union_id" type="hidden" value="<?php echo $unioun[0]['union_id']; ?>">
...
<?php 
 ...
 ?>
			...
			<div class="form-group">
				<label>Unioun Name</label><br>
				<?php echo form_input('unioun_name',$unioun[0]['unioun_name'],'class="form-congrol"'); ?>
			</div>
			<div class="form-group">
				<label>User Name</label><br>
				<?php echo form_input('username',$unioun[0]['unioun_name'],'class="form-congrol"'); ?>
