...
<br>
    ...
    var drpCatEarnning = document.getElementById('drpCatEarnning');
        ...
        <div class="container">
           <div class="col-lg-12" style="background-color: #4CAF50;height: 100px">
    <center>
        <h2 style="padding-top: 30px;color: #ffff">আপনার পণ্যের তালিকা</h2>
    </center>
</div>
<div class="col-lg-12">
    <center>
...
<?php if ($cart) {
        # code...
     ?>
        <form name="cart" action="farmerFinalOrder" method="post">
            <table name="cart" class="table table-striped table-bordered table" style="background-color: #17b884">
               <thead>
    <tr>
      <th scope="col">ক্রমিক নং</th>
      <th scope="col">পণ্যের নাম</th>
      <th scope="col">দাম(প্রতি কেজি)</th>
      <th scope="col">পরিমাণ(কেজি)</th>
      ...
      ?>
                <tr name="line_items">
                    <td><?php echo $i++; ?></td>
                    <td><input type="text" name="name" value="<?php echo $p->product_name; ?>" readonly></input></td>

                    <td><input type="text" name="price" value="<?php echo $p->product_price; ?>" readonly></td>
                    
                    <td><input type="number" onkeypress="restrictMinus(event); if(this.value.length==3) return false;" name="qty" value="<?php echo $p->product_quantity; ?>" ></td>
                    <td><input type="text" name="item_total" value="" jAutoCalc="{qty} * {price}"></td>
                    <td><a name="remove" class="btn btn-danger" style="color: white" href="<?php echo base_url('home/deleteOrder/'.$p->id) ?>" ><i class="fa fa-trash" aria-hidden="true"></a></td>
                </tr>
       
        <?php } ?>
                <tr>
                    <td colspan="4"><span style="margin-left: 90%;font-weight: bold">সর্বমোট</span></td>
            ...
            <div class="col-lg-12" style="background-color: #4CAF50;height: 120px;margin-top: -20px;margin-bottom: 80px">
    <center>
       <h2 style="padding-top: 30px;color: #ffff">আপনি কি এই দামে ক্রয় করতে আগ্রহী</h2>
       
    </center>
    <button type="submit" class="btn btn-primary" style="margin-left: 30%">হ্যাঁ</button>
    <span style="margin-left: 31%"><a class="btn btn-danger" href="<?php echo base_url('home/deleteAllOrder/'.$this->session->userdata('id')) ?>">না</a></span>
        ...
        <div class="col-lg-12" style="background-color: #4CAF50;height: 100px">
    <center>
        <h2 style="padding-top: 30px;color: #ffff">আপনি এখন পর্যন্ত কোন পণ্য কিনেন নি</h2>
    </center>
</div>
        <?php }  ?>
    </div>
...
function parseVal(r) {
    ...
    if (r.offset > startOffset) {
    ...
    else if ((match = /^[a-z_][0-9_]*/i.exec(r.string.substr(r.offset))) != null) {
        const name = match[0];
        ...
        if (r.string.length == r.offset) {
            ...
            alert('দয়া করে পজিটিভ নাম্বারে প্রবেশ করুন');
            return null;
        }
    }
}
