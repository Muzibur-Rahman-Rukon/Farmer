...
<div class="container">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php
       $j=$p->product_price*$p->product_quantity;
       echo $j."টাকা মাত্র";
       ?></td>
...
<?php   } else{ ?>
	<div class="col-lg-12"><center>
		<h3>আপনি এখন পর্যন্ত কোন পণ্য কিনেন নি</h3>
	</center></div>
<?php } ?>
...
<div class="container">
  <div class="row">
    ...
    <form action="<?php echo site_url('home/showSuccessbikroy') ?>" name="cart" method="post">


<table id="dataTable" class="table"  style="background-color: #17b884;margin-left:25%;margin-top: 5%">
  <thead>
    <tr>
...
<tbody>
  <?php 
    ...
    <tr name="line_items" id='row_0'>
     ...
     <td><input type="text"  required="required" class="name" name="name"  value="<?php echo $p->product_name; ?>" readonly>
              </td>
            <td>
               
   <input type="text"  required="required" class="price" name="price"  value="<?php echo $p->product_price; ?>" readonly>
            </td>

            <td>
              
                <input type="text"  required="required" class="qty" name="qty" value="<?php echo $p->product_quantity; ?>" >
            </td>
            
           
               
                 <!--<td><input type="text" size="3" readonly class="total" name="total" id="total" /></td>-->
                 <td><input type="text" name="item_total"jAutoCalc="{qty} * {price}"  value="" readonly></td>

            
            <td><a href="<?php echo base_url('home/destroyCart') ?>"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
 ...
 <?php } ?>
   ...
   <tfoot>
                        <tr>
            <td colspan="" style="text-align: right; font-weight: bold;">আপনি কি</td>
    <td><input type="text" name="sub_total" value="" jAutoCalc="{sub_total}"></td>

    <td colspan="0"><input type="text" name="item_total" jAutoCalc="SUM({item_total})"  id="total_subtotal" name="item_total" ></td><td style="text-align: right; font-weight: bold;">টাকায় বিক্রি করতে আগ্রহী</td>
...
<button type="submit" class="btn btn-success" style="margin-left: 20%">হ্যা</button>
<button class="btn btn-danger" style="margin-left: 25%"><a style="color:white" href="<?php echo base_url('home/destroyCart') ?>">না</a></button>
</form>
