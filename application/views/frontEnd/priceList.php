...
<div style="background-color: #6690e2">
...
<div class="row" >
  ...
  <h5 class="card-title" id="price"><center>সরকারী ক্রয় মূল্য<span style="color:#800000"><?php echo $p->buy_price; ?></span>টাকা মাএ</center></h5>
  <h5 class="card-title" id="price"><center>সরকারী বিক্রয় মূল্য<span style="color:#800000"><?php echo $p->sell_price; ?></span>টাকা মাএ</center></h5>
