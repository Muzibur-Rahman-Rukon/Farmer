...
<div class="container" style="height: 430px">
    ...
    <form action="<?php echo site_url('home/showSuccessbikroy/'.$id) ?>" name="cart" method="post">
...
<tbody>
    ...
    <tr name="line_items" id='row_0'>
     ...
     <td><input class="form-control rounded-0" type="text"  required="required" class="name" name="name"  value="<?php echo $product_name?>" readonly>
             	</td>
            <td>
               
   <input class="form-control rounded-0" type="text"  required="required" class="price" name="price"  value="<?php echo $items['price'] ?>" readonly>
            </td>
            <td><input class="form-control" type="number" onkeypress="restrictMinus(event); if(this.value.length==3) return false;" name="qty" value="<?php echo $items['qty'] ?>" ></td>

            
                 <td><input type="text" name="item_total"jAutoCalc="{qty} * {price}"  value="<?php echo $items['price'] ?>" readonly></td>
    </tr>
 ...
 <?php } ?>
   ...
   <tfoot>
    ...
    <td colspan="0"><input type="text" name="item_total" jAutoCalc="{qty} * {price}"  id="total_subtotal" name="item_total" ></td><td style="text-align: right; font-weight: bold;">টাকায় বিক্রি করতে আগ্রহী</td>
...
<button type="submit" class="btn btn-success" style="margin-left: 20%;margin-bottom: 10px">হ্যা</button>
<button  class="btn btn-danger" style="margin-left: 25%"><a style="color:white" href="<?php echo base_url('home/destroyCart/'.$id) ?>">না</a></button>
</form>
